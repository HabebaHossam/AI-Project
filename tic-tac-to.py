#immport used laibrary 
import copy
import sys
import pygame as pg
import random as rd
import numpy as np
#import value from const file
...
pg.display.set_caption('AI project Habiba Mohab Tamer')
#fill background
...
class Board:
    ...
    def __init__(self):
        ...
        self.squares = np.zeros( (ROWS, COLS) )#Rnew array filled with zeros.
...
# draw line over win
    def final_state(self, show=False):
        ...
        # vertical wins
        for col in range(COLS): #loop over all col to check verticall
